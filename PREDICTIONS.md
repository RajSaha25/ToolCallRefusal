...
| 8 | Gemma-27B mean-out ablation: coherent, KL 1-3, refusal flat-to-up. (Arditi-style drop is the ~20% outcome) | pending | |
| 9 | Random-direction control: within +/-3 points, 0% degeneracy for non-Gemma; Gemma 10-40% degenerate even from random. (80%) | Mistral -1 point, Command-R +0.5, both 0% degenerate. Gemma/Qwen/Llama pending. | **Held** so far |
| 10 | Mean-direction control breaks Gemma nearly completely, degrades the others moderately. (70%) | Mistral: 10% degenerate, refusal +5. Command-R: 6% degenerate but refusal -20 (0.68->0.48) -- the mean direction carries part of Command-R's refusal signal (cos(r, mean) = 0.20). Gemma pending (its mean-direction KL is 46). | **Partly**; Command-R's drop was not predicted |
| 11 | Addition at 1x: coherent (>= 90%) in all five; benign refusal ~0-5% -> 10-35%; at the largest coherent coefficient 30-60%, never 100%. (75%) | Mistral: coherent at 1x but refusal 0.0 -> 0.004; 2x is the ceiling (5% degenerate) at 6-10%; 3x is 97% degenerate. Command-R: 1x is already 50% degenerate (41% refusal among the coherent half); 1.5x and above 100% degenerate. | **Missed** in both directions: Mistral's effect is far smaller, Command-R's coherence ceiling is below 1x |
